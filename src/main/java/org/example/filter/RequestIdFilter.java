...
/**
 * Filter that generates a unique request ID (UUIDv7) for each incoming request.
 * The request ID is:
 * - Added to the response header (X-Request-Id)
 * - Stored in ThreadLocal for access throughout the request
 * - Added to SLF4J MDC for log correlation
 */
@Slf4j
@Component
