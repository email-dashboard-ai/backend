...
/**
 * Entity representing a Kanban column configuration.
 * Each user can have multiple custom columns that optionally map to Gmail
 * labels.
 */
@Entity
@Table(name = "kanban_columns", uniqueConstraints = @UniqueConstraint(columnNames = { "user_id", "column_id" }))
@Data
