...
public class EmailServiceImpl implements EmailService {
    ...
    public EmailServiceImpl(UserRepository userRepository, List<EmailProviderStrategy> strategyList) {
        ...
        // Convert list of strategies to a Map for O(1) lookup: { LOCAL -> MockStrategy, GOOGLE -> GoogleStrategy }
        this.strategies = strategyList.stream()
                .collect(Collectors.toMap(EmailProviderStrategy::getSupportedProvider, Function.identity()));
    }
